      ...
      >
        ...
        <div className="relative">
          <Swiper
            ...
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 TechNova-Swiper"
          >
            {/* Card */}
              ...
              <div className="flex-auto p-4 md:p-6">
                <p className="mt-3 sm:mt-6 text-base md:text-xl text-white">
                  <em>
                    ...
                    just clean, scalable code that worked out of the box. It
                    felt like having an extended dev team without the overhead."
                  </em>
                </p>
              </div>
              ...
              <div className="flex-auto p-4 md:p-6">
                <p className="mt-3 sm:mt-6 text-base md:text-xl text-white">
                  <em>
                    ...
                    didn’t just 'code it up' — they respected every detail,
                    optimized load times, and were always available for quick
                    tweaks. That’s rare."
                  </em>
                </p>
              </div>
              ...
              <div className="flex-auto p-4 md:p-6">
                <p className="mt-3 sm:mt-6 text-base md:text-xl text-white">
                  <em>
                    ...
                    explained everything in plain English. They didn’t just
                    deliver — they de-risked the entire process for me."
                  </em>
                </p>
              </div>
              ...
              <div className="flex-auto p-4 md:p-6">
                <p className="mt-3 sm:mt-6 text-base md:text-xl text-white">
                  <em>
                    ...
                    They’re the kind of dev team that makes you forget deadlines
                    because things just get done."
                  </em>
                </p>
              </div>
          ...
          {/* Add edge shadows */}
          <div className="absolute top-0 left-0 w-32 h-full bg-gradient-to-r from-neutral-900 to-transparent pointer-events-none z-10"></div>
          <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-neutral-900 to-transparent pointer-events-none z-10"></div>
        </div>
        {/* End Grid */}
      </div>
      {/* End Testimonials */}
